...
class ImageFragment : Fragment() {
    ...
    private fun updateMessage(downloadUri : Uri){
        ...
        val data = Message(image = downloadUri.toString(), type = type.toString(), priority = priority.toString())
    ...
    data class Message(val image: String, val type: String, val priority: String)
}
