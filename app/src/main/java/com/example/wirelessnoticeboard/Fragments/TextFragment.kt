...
class TextFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        binding.sendTextBtn.setOnClickListener {
            ...
            val data = Message(message = message.toString(), type = type.toString(), priority = priority.toString())
    ...
    data class Message(val message: String, val type: String, val priority: String)
}